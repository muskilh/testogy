...
var NPPC = require('./NuPackPriceCalculator');
 ...
 console.log("Testing Missing 1 Argument: ($1,299,000,000.99, food)");
 expect(
...
//Badly Formatted Args
 ...
 console.log("Testing Badly Formatted Price pt1: ($1,299.99, people 3 person 4, food)");
 expect(
	NPPC.priceCalc("$1,29.9.99", "people 3 person 4", "food")
 ).toThrow(/People Badly Formatted/);
 
 console.log("Testing Badly Formatted Price pt2: ($1,299.99, 3.5 people, food)");
 expect(
	NPPC.priceCalc("$1,29.9.99", "3.5 people", "food")
 ).toThrow(/People Badly Formatted/);
 
 console.log("Testing Badly Formatted Category: ($1,299.99, 3 people, 2)");
 expect(
	NPPC.priceCalc("$1,29.9.99", "3 people", 2)
 ...
 console.log("Testing Negative Price: (food, $1,299.99, -3 people)");
 expect(
	NPPC.priceCalc("food", "$1,299.99", "-3 people")
 ).toThrow(/Price Badly Formatted/);
